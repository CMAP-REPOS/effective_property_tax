...
write.xlsx(list(output = dists_by_taxcode_proc$cook, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_cook_2021.xlsx"), overwrite = TRUE)
...
write.xlsx(list(output = dists_by_taxcode_proc$dupage, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_dupage_2021.xlsx"), overwrite = TRUE)
...
write.xlsx(list(output = dists_by_taxcode_proc$kane, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_kane_2021.xlsx"), overwrite = TRUE)
...
write.xlsx(list(output = dists_by_taxcode_proc$kendall, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_kendall_2021.xlsx"), overwrite = TRUE)
...
write.xlsx(list(output = dists_by_taxcode_proc$lake, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_lake_2021.xlsx"), overwrite = TRUE)
...
write.xlsx(list(output = dists_by_taxcode_proc$mchenry, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_mchenry_2021.xlsx"), overwrite = TRUE)
...
write.xlsx(list(output = dists_by_taxcode_proc$will, 
           ...
           here("outputs", "2_dists_by_taxcode_proc_will_2021.xlsx"), overwrite = TRUE)
