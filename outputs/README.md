...
## Tax Code Map
**EffectiveTaxRates_2023.pdf** visualizes the effective tax rates across the region. At this time, data for DuPage and Lake are not available. The file is produced by `4_create_tax_map.R`. The data was processed and displayed in ArcGIS Pro by Shae Burnham.
