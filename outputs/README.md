...
## Tax Code Map
**EffectiveTaxRates_2021.pdf** visualizes the effective tax rates across the region. The file is produced by `4_create_tax_map.R`. The data was processed and diplayed in ArcGIS Pro by Shae Burnham.