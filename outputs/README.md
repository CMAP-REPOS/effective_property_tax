...
## tax rate map
**2018_effectiveptaxrates.pdf** visualizes the effective tax rates across the region. The data is produced in the `GIS` folder in scripts. It was then processed in ArcGIS Pro. 